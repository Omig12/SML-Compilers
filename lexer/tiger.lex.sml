...
fun yyQ44 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction49(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"A"
              then yyQ44(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
            else if inp < #"A"
              then if inp = #"."
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #"0"
                  ...
                  then yyAction49(strm, yyNO_MATCH)
                  else yyQ44(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
            else if inp = #"a"
              then yyQ44(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
            else if inp < #"a"
              then if inp = #"_"
       ...
       of NONE => yyAction49(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #"n"
                  then yyQ90(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
                  else yyQ44(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ44(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
              else yyAction49(strm, yyNO_MATCH)
       ...
       of NONE => yyAction49(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #"g"
                  then yyQ89(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
                  else yyQ44(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ44(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
              else yyAction49(strm, yyNO_MATCH)
       ...
       of NONE => yyAction49(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #"i"
                  then yyQ88(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
                  else yyQ44(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ44(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
              else yyAction49(strm, yyNO_MATCH)
       ...
       of NONE => yyAction49(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #"y"
                  then yyQ93(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
                  else yyQ44(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
              else yyAction49(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction49(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then yyQ92(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
            else if inp < #"a"
              then if inp = #"_"
                  then yyQ44(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
                  else yyAction49(strm, yyNO_MATCH)
       ...
       of NONE => yyAction49(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #"r"
                  then yyQ91(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
                  else yyQ44(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ44(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
              else yyAction49(strm, yyNO_MATCH)
...
fun yyQ18 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction33(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ99(strm', yyMATCH(strm, yyAction33, yyNO_MATCH))
